# Changes over V1:
# 1. Goes directly from the Structure_Downloads folder.
# 2. Used in DownloadAndAnalyzeRevised.py
...
if __name__ == "__main__":
    ...
    for species_fol in os.listdir(root_dir):
        print(species_fol)
        cif_dir = os.path.join(root_dir, species_fol, "Structure_Downloads")
