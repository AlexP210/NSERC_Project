...
if __name__ == "__main__":	
	...
	str_1 = MMCIFParser().get_structure('first_one', options.f1) # load your molecule
	str_2 = MMCIFParser().get_structure('second_one', options.f2) # load your molecule
	...
	if not os.path.exists(os.path.join(cwd, out_folder)): os.mkdir(os.path.join(cwd, out_folder))
	save_contacts(str_1,chains_1,os.path.join(cwd, out_folder,"molecule_1.pdb"))
	save_contacts(str_2,chains_2,os.path.join(cwd, out_folder,"molecule_2.pdb"))
